...
import 'package:presensimengajar_flutter/features/leave/presentation/blocs/admin_leave/admin_leave_bloc.dart';
import 'package:presensimengajar_flutter/features/leave/presentation/blocs/admin_leave/admin_leave_event.dart';
import 'package:presensimengajar_flutter/features/leave/presentation/blocs/admin_leave/admin_leave_state.dart';
...
class _AdminLeaveApprovalPageState extends State<AdminLeaveApprovalPage> {
  ...
  Future<void> _rejectRequest(String leaveId, String teacherName) async {
    ...
    if (reason != null && mounted) {
      ...
      context.read<AdminLeaveBloc>().add(
        AdminLeaveReject(leaveId: leaveId, reason: reason, adminId: adminId),
      );
    }
  }
